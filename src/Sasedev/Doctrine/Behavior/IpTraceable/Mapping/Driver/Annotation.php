<?php
namespace Sasedev\Doctrine\Behavior\IpTraceable\Mapping\Driver;
...
class Annotation extends AbstractAnnotationDriver
{
     ...
     */
    const IP_TRACEABLE = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\IpTraceable';

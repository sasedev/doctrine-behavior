<?php
namespace Sasedev\Doctrine\Behavior\Timestampable\Mapping\Driver;
    ...
    public function readExtendedMetadata($meta, array &$config)
    {
        ...
        if (isset($mapping['fields'])) {
            foreach ($mapping['fields'] as $field => $fieldMapping) {
                if (isset($fieldMapping['sasedev']['timestampable'])) {
                    $mappingProperty = $fieldMapping['sasedev']['timestampable'];

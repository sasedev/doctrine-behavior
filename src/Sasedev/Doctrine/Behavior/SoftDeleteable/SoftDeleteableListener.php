    ...
    public function onFlush(EventArgs $args)
    {
        ...
        foreach ($ea->getScheduledObjectDeletions($uow) as $object) {
            ...
            if (isset($config['softDeleteable']) && $config['softDeleteable']) {
                ...
                $evm->dispatchEvent(self::PRE_SOFT_DELETE, $ea->createLifecycleEventArgsInstance($object, $om));
                ...
                $evm->dispatchEvent(self::POST_SOFT_DELETE, $ea->createLifecycleEventArgsInstance($object, $om));
            }
        }

...
class TranslationProxy
{
     ...
     *            object properties to translate
     * @param string $class
     *            translation entity|document class
    ...
    public function getTranslatedValue($property)
    {
        ...
        return $this->findOrCreateTranslationForProperty($property, $this->getProxyLocale())
            ->getValue();
    ...
    public function setTranslatedValue($property, $value)
    {
        ...
        $this->findOrCreateTranslationForProperty($property, $this->getProxyLocale())
            ->setValue($value);

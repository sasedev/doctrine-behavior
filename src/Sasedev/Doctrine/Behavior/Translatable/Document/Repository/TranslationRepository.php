...
class TranslationRepository extends DocumentRepository
{
    ...
    public function translate($document, $field, $locale, $value)
    {
        ...
        else
        {
            ...
            $foreignKey = $meta->getReflectionProperty($meta->identifier)
                ->getValue($document);
            ...
            if ($this->dm->getUnitOfWork()
                ->isInIdentityMap($document))
            {

<?php
namespace Sasedev\Doctrine\Behavior\Tree\Mapping\Driver;
...
use Sasedev\Doctrine\Behavior\Tree\Mapping\Validator;
...
class Annotation extends AbstractAnnotationDriver
{
     ...
     */
    const TREE = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\Tree';

    /**
     * Annotation to mark field as one which will store left value
     */
    const LEFT = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeLeft';

    /**
     * Annotation to mark field as one which will store right value
     */
    const RIGHT = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeRight';

    /**
     * Annotation to mark relative parent field
     */
    const PARENT = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeParent';

    /**
     * Annotation to mark node level
     */
    const LEVEL = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeLevel';

    /**
     * Annotation to mark field as tree root
     */
    const ROOT = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeRoot';

    /**
     * Annotation to specify closure tree class
     */
    const CLOSURE = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeClosure';

    /**
     * Annotation to specify path class
     */
    const PATH = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreePath';

    /**
     * Annotation to specify path source class
     */
    const PATH_SOURCE = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreePathSource';

    /**
     * Annotation to specify path hash class
     */
    const PATH_HASH = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreePathHash';

    /**
     * Annotation to mark the field to be used to hold the lock time
     */
    const LOCK_TIME = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Annotation\\TreeLockTime';

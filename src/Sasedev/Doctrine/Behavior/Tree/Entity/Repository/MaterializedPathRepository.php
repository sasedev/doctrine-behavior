 ...
 * to interact with MaterializedPath tree.
 * Repository uses
...
class MaterializedPathRepository extends AbstractTreeRepository
{
    ...
    public function getTreeQuery($rootNode = null)
    {
        ...
        return $this->getTreeQueryBuilder($rootNode)
            ->getQuery();
    ...
    public function getTree($rootNode = null)
    {
        ...
        return $this->getTreeQuery($rootNode)
            ->execute();
    ...
    public function getChildrenQueryBuilder($node = null, $direct = false, $sortByField = null, $direction = 'asc', $includeNode = false)
    {
        ...
        if (is_object($node) && $node instanceof $meta->name)
        {
            ...
            if ($includeNode)
            {
                $includeNodeExpr = $qb->expr()
                    ->eq($alias . '.' . $path, $qb->expr()
                    ->literal($nodePath));
            }
            else
            {
                $expr->add($qb->expr()
                    ->neq($alias . '.' . $path, $qb->expr()
                    ->literal($nodePath)));
            }
    ...
    public function getChildren($node = null, $direct = false, $sortByField = null, $direction = 'asc', $includeNode = false)
    {
        ...
        return $this->getChildrenQuery($node, $direct, $sortByField, $direction, $includeNode)
            ->execute();
    ...
    public function getNodesHierarchy($node = null, $direct = false, array $options = [], $includeNode = false)
    {
        ...
        $nodes = $this->getNodesHierarchyQuery($node, $direct, $options, $includeNode)
            ->getArrayResult();
        usort($nodes, function ($a, $b) use ($path)
        {

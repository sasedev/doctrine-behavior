 ...
 *
 * @sasedev:Sluggable
 * to mark the field as sluggable use property annotation @sasedev:Sluggable
 * this field value will be included in built slug
 */

/**
 *
 * @sasedev:Slug - to mark property which will hold slug use annotation @sasedev:Slug
 * available options:
 ...
 * example:
 *
 * @sasedev:Slug(style="camel", separator="_", prefix="", suffix="", updatable=false, unique=false)

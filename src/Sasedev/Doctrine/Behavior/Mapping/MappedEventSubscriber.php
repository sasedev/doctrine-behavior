...
abstract class MappedEventSubscriber implements EventSubscriber
{
    ...
    protected function getEventAdapter(EventArgs $args)
    {
        ...
        ]))
        {
            if (! isset($this->adapters[$m[1]]))
            {
                ...
                {
                    $adapterClass = 'Sasedev\\Doctrine\\Behavior\\Mapping\\Event\\Adapter\\' . $m[1];
                }
    ...
    public function getExtensionMetadataFactory(ObjectManager $objectManager)
    {
        ...
        if (! isset($this->extensionMetadataFactory[$oid]))
        {
            ...
            $this->extensionMetadataFactory[$oid] = new ExtensionMetadataFactory($objectManager, $this->getNamespace(), $this->annotationReader);
        }
